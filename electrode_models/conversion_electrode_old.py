...
class electrode(): 
    ...
    def __init__(self, input_file, inputs, sep_inputs, counter_inputs,    
        ...
        # electrolyte composition (n_species)+ self.elyte_obj.n_species)
        self.n_vars_node = (2 + self.n_conversion_phases 
            + self.elyte_obj.n_species)
        self.n_vars = 2#self.n_points * self.n_vars_node
    ...
    def residual(self, t, SV, SVdot, sep, counter, params):
        ...
        if self.name=='anode':
            ...
            if params['boundary'] == 'current':
                ...
                resid[SVptr['phi_ed'][0]] = i_io - params['i_ext']
                ...
                print('resid, ',resid[SVptr['phi_ed']])
        # print(SV_loc)
    ...
    def voltage_lim(self, SV, val):
        ...
        # looks for instances where this value changes sign (i.e. crosses 
        # zero)    
